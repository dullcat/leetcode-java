package oa_k_distinct_substring;

import java.util.*;
import org.junit.*;
import static org.junit.Assert.*;

public class OAKDistinctSubstring {
...
// CLASS BEGINS, THIS CLASS IS REQUIRED
    ...
    public static class UnitTest {
        @Test
        public void testOAKDistinctSubstring() {
            OAKDistinctSubstring.Solution s = new OAKDistinctSubstring().new Solution();
